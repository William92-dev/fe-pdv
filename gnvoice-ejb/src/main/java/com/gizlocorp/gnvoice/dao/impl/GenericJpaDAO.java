...
import com.gizlocorp.gnvoice.dao.GenericDAO;
...
//
//        EntityManager manager = (EntityManager) attributes.get(GenericJpaDAO.class);
//
//        if (manager == null) {
//            manager = em;
//            attributes.put(GenericJpaDAO.class, manager);
