...
//@Audited
@Entity
@Table(name = "tb_factura_his", schema = "historico")
public class FacturaHist implements Serializable {
...
//	 private boolean traducido;
	...
	@Transient
	private Boolean selectFactura = false;
	...
	public Boolean getSelectFactura() {
		return selectFactura;
	}

	public void setSelectFactura(Boolean selectFactura) {
