...
//@Audited
@Entity
@Table(name = "tb_nota_credito_recepcion")
public class NotaCreditoRecepcion implements Serializable {
	 ...
	 */
	@Id
	@SequenceGenerator(name = "seq_nota_credito_recepcion", sequenceName = "seq_nota_credito_recepcion", allocationSize = 1)
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_nota_credito_recepcion")
	@Column(name = "id", nullable = false)
	private Long id;
	...
	@Column(nullable = true, name = "cod_doc_modificado", length = 100)
	private String codDocModificado;

	@Column(nullable = true, name = "num_doc_modificado", length = 100)
	...
	@Column(name = "tarea", nullable = true, length = 3)
	@Enumerated(EnumType.STRING)
	...
	@Column(name = "sub_total", length = 8, scale = 2)
	private BigDecimal subTotal;

	@Column(name = "valor_total", length = 8, scale = 2)
	...
	public String getRazonSocialComprador() {
		if (razonSocialComprador != null) {
			razonSocialComprador = StringEscapeUtils.unescapeXml(razonSocialComprador);
		}
