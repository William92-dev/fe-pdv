...
public class PropertiesUtil {
	...
	private PropertiesUtil(String directorioServidor) {
		propiedades = new Properties();
		try {
			propiedades.load(new FileInputStream(directorioServidor+URL_PROPIEDADES));
		} catch (IOException e) {
	...
	public static PropertiesUtil getInstance(String directorioServidor) {
		if (instance == null) {
			instance = new PropertiesUtil(directorioServidor);
		}
		return instance;
	}
