    ...
    extends Service
{
    ...
    static {
        AUTORIZACIONCOMPROBANTESOFFLINESERVICE_WSDL_LOCATION = ec.gob.sri.comprobantes.ws.offline.aut.AutorizacionComprobantesOfflineService.class.getResource("https://cel.sri.gob.ec/comprobantes-electronicos-ws/AutorizacionComprobantesOffline?wsdl");
        WebServiceException e = null;
        if (AUTORIZACIONCOMPROBANTESOFFLINESERVICE_WSDL_LOCATION == null) {
            e = new WebServiceException("Cannot find 'https://cel.sri.gob.ec/comprobantes-electronicos-ws/AutorizacionComprobantesOffline?wsdl' wsdl. Place the resource correctly in the classpath.");
        }
