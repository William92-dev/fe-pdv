...
/**
 * <p>Clase Java para guiaRecibirRequest complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="guiaRecibirRequest">
 *   &lt;complexContent>
...
@XmlType(name = "guiaRecibirRequest", propOrder = {
    "comprobanteProveedor"
})
public class GuiaRecibirRequest {
