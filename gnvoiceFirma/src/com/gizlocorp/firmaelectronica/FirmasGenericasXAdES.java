...
public class FirmasGenericasXAdES extends FirmaGenerica {
	...
	public FirmasGenericasXAdES(String directorioSalidaFirma,
			Provider provider, X509Certificate certificado,
			PrivateKey privateKey, String archivoAFirmar, String archivoFirmado) {
	...
	public void ejecutarFirmaXades(String pathArchivoXMLFirmar,
			String pathDirectorioSalida, String nombreArchivoFirmado,
			Provider provider, X509Certificate certificado,
			PrivateKey privateKey) throws ParserConfigurationException,
			SAXException, IOException {
		FirmasGenericasXAdES signature = new FirmasGenericasXAdES(
				pathDirectorioSalida, provider, certificado, privateKey,
				pathArchivoXMLFirmar, nombreArchivoFirmado);
