...
import com.gizlocorp.gnvoice.jobs.ReprocesoBatchJobs;
import com.gizlocorp.gnvoice.modelo.ClaveContingencia;
import com.gizlocorp.gnvoice.service.FacturaRest;
...
@Service(FacturaRest.class)
public class FacturaRestBean implements FacturaRest {

	@Resource(mappedName = "java:/queue/facturaProcesarQueue")
	private Queue queue;
	...
	private static Logger log = Logger.getLogger(FacturaRestBean.class
			.getName());
	...
	@Override
	public FacturaRestProcesarResponse procesar(String parametros) {
		log.debug("**Servicio procesar en linea");
		String respuestaJMS = inqueue(parametros, this.queue);

		FacturaRestProcesarResponse respuesta = new FacturaRestProcesarResponse();
		respuesta.setHttpStatus("104");
		respuesta.setRespuesta(respuestaJMS != null ? respuestaJMS: Constantes.RESPUESTA_OK);
		return respuesta;

	}

	@Override
	public FacturaRestGenerarClaveAccesoResponse generarClaveAcceso(
			String parametros) {

		String codEstab = null, ptoEmision = null, secuencial = null, ruc = null, fechaEmision = null;

		FacturaRestGenerarClaveAccesoResponse respuestaClaveAcceso = new FacturaRestGenerarClaveAccesoResponse();
		FacturaRestGenerarClaveAccesoResponse.Respuesta respuesta = new FacturaRestGenerarClaveAccesoResponse.Respuesta();
...
//				}
	...
	public String bacth(String empresa) {
		...
		new ReprocesoBatchJobs().executebatch();
		*/
		...
		return "EMPEIZA EL DESMADRE 09/01/2017";
